    ...
    <dl v-for="item in goods.specs" :key="item.id">
      ...
      <dd>
        <template v-for="val in item.values" :key="val.name">
          <img :src="val.picture" @click="changeSku(item, val)" :title="val.name" :class="{ selected: val.selected, disabled: val.disabled }" v-if="val.picture" alt="">
          <span @click="changeSku(item, val)" :class="{ selected: val.selected, disabled: val}" v-else></span>
        </template>
      </dd>
    </dl>
  </div>
